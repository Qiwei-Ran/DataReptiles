...
import Queue
import lxml.html
from csv_store import ScrapeCallback


# add the scrape callback
def link_crawler(seed_url, link_regex=None, delay=5, max_depth=-1, max_urls=-1, headers=None, user_agent='wswp',
    ...
    while crawl_queue:
        ...
        if rp.can_fetch(user_agent, url):
            ...
            if scrape_callback:  # other url or html list
...
if __name__ == '__main__':
    ...
    link_crawler('http://example.webscraping.com', '/(index|view)', delay=0, num_retries=1, max_depth=3,
